...
export const getAllGraphs = async () => {
  try {
    const response = await fetch(
      `${SERVER_URL}:4000/backend/index.php/api/getAllGraphs`,
      {
        method: "POST",
        headers: {
...
export const getGraph = async (id) => {
  try {
    const response = await fetch(
      `${SERVER_URL}:4000/backend/index.php/api/getGraph`,
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
...
export const saveGraph = async ({
  ...
  try {
    ...
    const response = await fetch(
      `${SERVER_URL}:4000/backend/index.php/api/saveGraph`,
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
...
export const delGraph = async (id) => {
  try {
    const response = await fetch(
      `${SERVER_URL}:4000/backend/index.php/api/deleteGraph`,
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
...
export const deleteAllGraphs = async (id) => {
  try {
    const response = await fetch(
      `${SERVER_URL}:4000/backend/index.php/api/deleteAllGraphs`,
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
...
export const addGraph = async (graph = {}, id = null) => {
  ...
  try {
    ...
    const response = await fetch(
      `${SERVER_URL}:4000/backend/index.php/api/addGraph`,
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
...
export const getLogs = async (id) =>
  await db.logs.where("graphId").equals(id).desc().toArray();
...
export const getAllApplications = async () => {
  try {
    const response = await fetch(
      `${SERVER_URL}:4000/backend/index.php/api/getAllApplications`,
      {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
...
export const saveApplication = async (utilData = {}, appId = null) => {
  ...
  try {
    ...
    const response = await fetch(
      `${SERVER_URL}:4000/backend/index.php/api/saveApplication`,
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
...
export const delApplication = async (id) => {
  try {
    const response = await fetch(
      `${SERVER_URL}:4000/backend/index.php/api/deleteApplication`,
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
...
export const deleteAllApplications = async (id) => {
  try {
    const response = await fetch(
      `${SERVER_URL}:4000/backend/index.php/api/deleteAllApplications`,
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
...
export const addApplication = async (utilData = {}, id = null) => {
  ...
  try {
    ...
    const response = await fetch(
      `${SERVER_URL}:4000/backend/index.php/api/addApplication`,
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
...
export const getAllForms = async () => {
  try {
    const response = await fetch(
      `${SERVER_URL}:4000/backend/index.php/api/getAllForms`,
      {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
...
export const saveForm = async (formId, utilData = {}) => {
  ...
  try {
    ...
    const response = await fetch(
      `${SERVER_URL}:4000/backend/index.php/api/saveForm`,
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
...
export const delForm = async (id) => {
  try {
    const response = await fetch(
      `${SERVER_URL}:4000/backend/index.php/api/deleteForm`,
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
...
export const deleteAllForms = async (id) => {
  try {
    const response = await fetch(
      `${SERVER_URL}:4000/backend/index.php/api/deleteAllForms`,
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
...
export const addForm = async (utilData = {}, appId = null) => {
  ...
  try {
    ...
    const response = await fetch(
      `${SERVER_URL}:4000/backend/index.php/api/addForm`,
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
...
export const getAllQueries = async () => {
  try {
    const response = await fetch(
      `${SERVER_URL}:4000/backend/index.php/api/getAllQueries`,
      {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
...
export const saveQuery = async (queryId, utilData = {}) => {
  ...
  try {
    ...
    const response = await fetch(
      `${SERVER_URL}:4000/backend/index.php/api/saveQuery`,
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
...
export const delQuery = async (id) => {
  try {
    const response = await fetch(
      `${SERVER_URL}:4000/backend/index.php/api/deleteQuery`,
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
...
export const deleteAllQueries = async (id) => {
  try {
    const response = await fetch(
      `${SERVER_URL}:4000/backend/index.php/api/deleteAllQueries`,
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
...
export const addQuery = async (utilData = {}, appId = null) => {
  ...
  try {
    ...
    const response = await fetch(
      `${SERVER_URL}:4000/backend/index.php/api/addQuery`,
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
...
export const runQuery = async (
  ...
  try {
    if (queryString?.length > 0) {
      const response = await fetch(
        `${SERVER_URL}:4000/backend/index.php/api/runQuery`,
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
